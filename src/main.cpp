        ...
        switch (config.type){
                ...
                case VID: {
                        ...
                        while (!finished){
                                ...
                                printw("[%d] Record Video:  Press 'r' to start or stop recording.\n", (config.record_video)?1:0);
                                printw("[%d] Take Snapshot: Press 's' to take snapshot.\n", (config.take_snapshot)?1:0);
                                printw("Press 'q' to quit.\n");
                                
                                // Add Metrics per packet. Total Time, PNET, RNET, ONET, Avg FPS
                                // Add it to Output thread?
                ...
                case IMG: {
                        ...
                        CHECK(!img.empty()) << "Unable to decode image " << config.full_file_name;
