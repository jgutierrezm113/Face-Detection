...
plot  "MTCNN-ContROC.txt" using 2:1 title 'MTCNN' with linespoints pointinterval 50 lw 3 , \
"ContROC.txt" using 2:1 title 'JGM' with linespoints pointinterval 50 lw 3 
