...
set yr [0:1.0]
set key below
set output "contROC-compare-ours.png"
...
"rocCurves/MTCNN-ContROC.txt" using 2:1 title 'MTCNN' with lines lw 2, \
"rocCurves/JGM-ContROC.txt" using 2:1 title 'Our' with lines lw 2
